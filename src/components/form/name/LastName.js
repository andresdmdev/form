...
export default function LastName({ register, handleErrors }){
    ...
    return(
        <div className="w-full mb-3 sm:mb-5">
            <label htmlFor="lastName" className="ml-3 leading-5 sm:ml-4 text-base font-semibold">Last name *</label>
            ...
            {   
                handleErrors.lastName && <ShowError msgError={handleErrors.lastName.message} />
            }
        </div>
    )
}